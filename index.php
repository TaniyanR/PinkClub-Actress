...
try {
    ...
    error_log('home actress fetch failed: ' . $e->getMessage());
    $allActresses = [];
}
  ...
  <section class="pca-grid" aria-label="女優一覧">
    <?php foreach ($actresses as $actress): ?>
      ...
      <article class="pca-card">
        <a class="pca-card__link" href="<?= e(public_url('actress.php?id=' . $id)) ?>">
...
<?php else: ?>
  <?php pcf_render_empty('女優データがまだありません。管理画面の女優情報APIから同期してください。'); ?>
<?php endif; ?>
